 ...
 * 부분문자열 매칭이라 짧은 말은 고른다: '대부'는 '대부분'에, '사채'는
 * '회사채'에, '사채업'은 '회사채 업계'에 걸리므로 쓰지 않는다.
 */
const LENDING_CONTEXT = [
  "대부업", "불법대부", "미등록대부", "대부중개", "대부광고",
  "추심", "사금융", "불법사채", "사채업자", "고리대", "고금리",
  "이자제한", "불법대출", "작업대출", "내구제", "폰테크",
];
